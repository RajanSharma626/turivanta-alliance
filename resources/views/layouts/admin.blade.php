    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 glass-panel border-r border-white/5 flex flex-col z-50">
            ...
            <nav class="flex-grow px-4 space-y-2 py-4">
                ...
                <a href="{{ route('admin.events') }}" class="sidebar-link px-4 py-3 rounded-xl flex items-center gap-3 text-sm font-semibold transition-all hover:bg-white/5 {{ request()->routeIs('admin.events*') ? 'active' : 'text-gray-400' }}">
