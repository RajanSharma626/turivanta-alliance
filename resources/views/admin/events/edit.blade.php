...
@section('title', 'Edit Events - Turivanta Admin')
@section('page_title', 'Modify Events Details')
...
<div class="max-w-4xl mx-auto">
    <div class="glass-panel p-10 rounded-[40px] border border-white/5 relative overflow-hidden group">
        ...
        <div class="mb-10 relative z-10">
            <h3 class="text-white font-black heading-font text-2xl tracking-tighter uppercase italic mb-2">Update Events</h3>
