...
<div class="glass-panel p-8 rounded-[40px] border border-white/5 overflow-hidden">
    <div class="flex flex-col sm:flex-row items-center justify-between mb-8 px-4 gap-4">
        <h3 class="text-white font-black heading-font text-lg tracking-tight uppercase italic grow">Registered User Base</h3>
                    ...
                    <tr class="bg-white/[0.02] hover:bg-white/[0.05] transition-all border border-white/5 group translate-y-0 hover:-translate-y-1">
                        <td class="py-5 pl-6 rounded-l-3xl border-y border-l border-white/5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-[9px] text-gray-500 font-extrabold uppercase tracking-widest mt-0.5">UID: {{ $member->id }}</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="py-5 pr-6 rounded-r-3xl border-y border-r border-white/5">
                            @if($member->email_verified_at)
                                <span class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-500 border border-emerald-500/20">Verified</span>
                            @else
                                <span class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-yellow-500/10 text-yellow-500 border border-yellow-500/20">Pending</span>
                            @endif
                        </td>
                    </tr>
                @empty
