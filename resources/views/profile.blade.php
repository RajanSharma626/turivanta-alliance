            ...
            <div class="bg-[#0a0a0f] border border-white/5 rounded-3xl overflow-hidden shadow-2xl animate-fadeIn">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div class="bg-white/[0.02] border border-white/5 p-6 rounded-2xl h-full">
                                            ...
                                            <ul class="space-y-3 text-gray-400 text-sm leading-relaxed">
                                                ...
                                                <li class="flex gap-3"><span>•</span> Annual Return reflecting current share
                                                    capital details (mandatory)</li>
                                                <li class="flex gap-3"><span>•</span> CA letter confirming the shareholding
                                                    details & percentages</li>
                                                <li class="flex gap-3"><span>•</span> Valid Passport or Photo ID Card of
                                                    each shareholders</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="bg-white/[0.02] border border-white/5 p-6 rounded-2xl h-full">
                                            ...
                                            <ul class="space-y-3 text-gray-400 text-sm leading-relaxed">
                                                ...
                                                <li class="flex gap-3"><span>•</span> CA Letter confirming the partnership
                                                    details & percentage</li>
                                                <li class="flex gap-3"><span>•</span> Valid Passport or Photo ID Card of
                                                    each partners</li>
                                                <li class="flex gap-3"><span>•</span> Signed Application Summary Form with
                                                    signatory of all the partners</li>
                                            </ul>
                                        </div>
                                    ...
                                    <section class="bg-white/[0.02] border border-white/5 p-6 rounded-2xl h-full">
                                        ...
                                        <ul class="space-y-3 text-gray-400 text-sm leading-relaxed ml-4">
                                            ...
                                            <li class="flex gap-3"><span>•</span> If shareholders are corporation, provide
                                                certificate of incorporation of parent company</li>
                                        </ul>
                                    </section>
                                </div>
                            </div>
                ...
                @elseif($user->current_step == 2)
                    ...
                    <div class="p-8 sm:p-12">
                        ...
                        <form id="step2-form" action="{{ route('profile.next') }}" method="POST"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="legal_status"
                                    ...
                                    @foreach (['Association', 'Co-operative', 'Corporation', 'Joint Venture', 'Limited Company', 'Limited Partnership', 'Partnership', 'Sole Proprietorship', 'State Owned Enterprise', 'Trust Company', 'In Service Professional', 'Student'] as $status)
                                        <option value="{{ $status }}"
                                            {{ old('legal_status', $user->legal_status) == $status ? 'selected' : '' }}>
                                            {{ $status }}</option>
                                    @endforeach
                                </select>
                                @error('legal_status')
                            ...
                            <div class="space-y-8">
                                ...
                                <script>
                                    document.getElementById('same_as_billing').addEventListener('change', function() {
                                        if (this.checked) {
                                            document.getElementById('shipping_country').value = document.getElementById('billing_country')
                                                .value;
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <select name="iata_registered" id="iata_registered"
                                            ...
                                            <option value="yes"
                                                ...
                                                Yes</option>
                                            <option value="no"
                                                {{ old('iata_registered', $application->iata_registered ? 'yes' : 'no') == 'no' ? 'selected' : '' }}>
                                                No</option>
                                        </select>
                ...
                @elseif($user->current_step == 4)
                    ...
                    <div class="p-8 sm:p-12">
                        <div class="flex items-center gap-4 mb-2">
                            <div
                                class="w-10 h-10 bg-emerald-500/10 rounded-full flex items-center justify-center border border-emerald-500/20">
                ...
                @else
                    ...
                    <div class="p-12 text-center py-24">
                        <div
                            class="inline-flex items-center justify-center w-24 h-24 bg-emerald-500/10 rounded-full mb-8 border border-emerald-500/20 shadow-[0_0_50px_rgba(16,185,129,0.1)]">
