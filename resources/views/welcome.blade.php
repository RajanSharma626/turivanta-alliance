...
@section('content')
        ...
        <div class="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20 items-center">
            ...
            <div class="flex flex-col space-y-7 z-10 relative">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2">
                    <div
                        class="bg-[#111113] border border-white/5 rounded-2xl p-7 hover:border-[#ff014f]/30 transition-all duration-300 group">
                        <div
                        ...
                        <p class="text-gray-400 text-[13px] leading-[1.7] text-justify">Network of tourism businesses, travel agencies,
                    ...
                    <div
                        ...
                        <p class="text-gray-400 text-[13px] leading-[1.7] text-justify">Turivanta symbol is an instant recognition of
                            trusted tourism business, travel service or hospitality provider.</p>
                    </div>
                </div>

                <div class="pt-8 border-t border-white/5">
                    <h5 class="text-[#ff014f] font-bold text-[13px] tracking-[0.2em] uppercase mb-4 text-center sm:text-left">Excellence</h5>
                    <h3 class="text-2xl sm:text-3xl font-extrabold text-white mb-4 text-center sm:text-left">
                        Inspiring the World Through <br class="hidden sm:block" /> Tourism Excellence
                    </h3>
                    <p class="text-gray-400 text-[15px] leading-[1.8] text-center sm:text-left text-justify">
                        Turivanta Alliance provides expert guidance and strategic support to tourism businesses, helping them enhance performance, build trust, and achieve sustainable growth in the global travel and hospitality industry.
                    </p>
                    <p class="text-gray-500 text-[13px] italic leading-[1.8] mt-6 border-l-2 border-[#ff014f]/20 pl-4 text-justify">
                ...
                <div class="pt-5 flex justify-center sm:justify-start">
                    <a href="{{ route('about') }}"
                        class="inline-flex items-center gap-2 px-8 py-[14px] bg-[#ff014f] text-white font-bold rounded-full transition-all duration-300 hover:bg-[#e11d48] w-max shadow-[0_10px_20px_rgba(255,1,79,0.2)] hover:shadow-[0_10px_25px_rgba(255,1,79,0.4)]">
    ...
    <section class="w-full px-6 py-24 z-10 relative bg-[#030712]">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    <div class="w-14 h-14 bg-gradient-to-tr from-[#ff014f] to-rose-400 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Tourism Industry Platform</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Discover a powerful tourism industry platform that connects global stakeholders, boosts visibility, and drives growth through a trusted platform.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Tourism Business Network</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Join a dynamic tourism business network that builds partnerships, expands reach, and accelerates growth through a global ecosystem.</p>
                </div>

                <!-- 3. Global Tourism Alliance -->
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    <div class="w-14 h-14 bg-gradient-to-tr from-[#ff014f] to-rose-400 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h1.5a3.5 3.5 0 013.5 3.5V17m-6-10a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-4">Global Tourism Alliance</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Be part of a global tourism alliance that unites industry leaders, fosters collaboration, and drives innovation through a scalable network.</p>
                </div>

                <!-- 4. Travel and Hospitality Network -->
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    <div class="w-14 h-14 bg-gradient-to-tr from-[#ff014f] to-rose-400 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9h18"></path></svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-4">Travel and Hospitality Network</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Explore a leading travel and hospitality network that connects brands, enhances services, and creates opportunities globally.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Tourism Service Providers</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Connect with top tourism service providers, showcase services, and grow your business using a trusted platform designed for global providers.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Tourism Business Directory</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">List your company in a tourism business directory that improves visibility, attracts leads, and drives growth through a global directory.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Travel Industry Association</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Join a trusted travel industry association that supports members, influences policy, and promotes standards globally.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/[0.08] hover:border-[#ff014f]/30 transition-all duration-500 group">
                    ...
                    <h3 class="text-xl font-bold text-white mb-4">Hospitality Business Network</h3>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify">Grow with a hospitality business network that connects hotels, partners, and suppliers while boosting global opportunities.</p>
                </div>
            </div>
        </div>
    </section>
